...
$(function () {
    ...
    ***************************/
    ...
    var accent = 'rgba(135, 216, 50, 1)';  // Orange accent for dark mode
    var dark = '#000';
    var light = '#fff';
    ...
    ***************************/
    function initializeShapes() {
        // Clone arrows and lines as before
        $(".mil-arrow").clone().appendTo(".mil-arrow-place");
        $(".mil-lines").clone().appendTo(".mil-lines-place");
        $(".mil-main-menu ul li.mil-active > a").clone().appendTo(".mil-current-page");

        // Dynamically assign shapes to animation containers
        $(".mil-animation").each(function() {
            var $container = $(this);
            var shapeType = $container.data("shape-type") || "dodecahedron"; // default to dodecahedron

            // Clear existing shapes
            $container.find(".mil-shape").remove();

            // Clone the appropriate shape from templates
            var shapeClass = ".mil-" + shapeType;
            var $shape = $(shapeClass).clone();

            if ($shape.length > 0) {
                $container.append($shape);
            } else {
                // Fallback to dodecahedron if shape not found
                $(".mil-dodecahedron").clone().appendTo($container);
            }
        });
    }
    ...
    ***************************/
    ...
    document.addEventListener("swup:contentReplaced", function () {
        ...
        ***************************/
        ...
        append & shape system reinit

        ***************************/
        $(document).ready(function () {
            $(".mil-arrow-place .mil-arrow, .mil-animation .mil-shape, .mil-current-page a").remove();
            initializeShapes();
        });
        /***************************
